...
$acao10 = 'recuperar2';
require_once '../controller/categoriaativos_controller.php';
...
<DOCTYPE html>
	...
	<body>
		...
		<?php if (isset($_GET['acao5']) && $_GET['acao5'] == 'atualizar') { ?>
			...
			<?php $categoria_id = $_POST['categoria_id']?>
									...
									<div class="row">
										<div class="col-sm-2">
											<div class="form-group">
												...
												<input style="font-size: 1em;" class="form-control" type="text" name="ativo" id="ativo" value="<?= $ativo?>" aria-label="Número do item" required>
											</div>
										</div>
										<div class="col-sm-10">
											<div class="form-group">
										...
										<div class="col-sm-2">
											<div class="form-group">
												...
												<select style="font-size: 1em;" name="categoria_id" class="custom-select" id="categoria_id" value="<?= $categoria_id?>"aria-label="Selecione uma categoria"  required>
													<option selected="true" id="<?= $categoria_id?>" value="<?= $categoria_id?>"><?= $categoria?></option>
													<?php 
													$acao10 = 'recuperar2';
													require_once "../controller/categoriaativos_controller.php";
													foreach($categorias as $key => $categoria):  ?>
														<option name="categoria_id" value="<?= $categoria->id?>"><?= $categoria->categoria ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
