  ...
  <!-- Bootstrap core CSS -->
    ...
    <script>
      ...
      function pesquisarporativo(txt_ativoopcao, txt_descricao, txt_eam, txt_chassi, txt_ativo, txt_placa, txt_empresa) {
      ...
      if (txt_ativoopcao == 0) { 
        ...
        location.href = 'todas.remessas.php?acao8=recuperarPorAtivo&txt_descricao='+txt_descricao+'&txt_ativoopcao=1&pagina=1'
      } else if (txt_ativoopcao == 2) { 
        location.href = 'todas.remessas.php?acao8=recuperarPorAtivo&txt_eam='+txt_eam+'&txt_ativoopcao=2&pagina=1'
      } else if (txt_ativoopcao == 3) { 
        location.href = 'todas.remessas.php?acao8=recuperarPorAtivo&txt_chassi='+txt_chassi+'&txt_ativoopcao=3&pagina=1'
      } else if (txt_ativoopcao == 4) { 
        location.href = 'todas.remessas.php?acao8=recuperarPorAtivo&txt_ativo='+txt_ativo+'&txt_ativoopcao=4&pagina=1'
      } else if (txt_ativoopcao == 5) { 
        location.href = 'todas.remessas.php?acao8=recuperarPorAtivo&txt_placa='+txt_placa+'&txt_ativoopcao=5&pagina=1'
      } else if (txt_ativoopcao == 6) { 
        location.href = 'todas.remessas.php?acao8=recuperarPorAtivo&txt_empresa='+txt_empresa+'&txt_ativoopcao=6&pagina=1'
      } else if (txt_ativoopcao == 7) { 
        location.href = 'todas.remessas.php?acao8=recuperarPorAtivo&txt_empresa='+txt_empresa+'&txt_ativoopcao=7&pagina=1'
      }
  ...
  <main role="main" style="margin-bottom: 1px;padding: 1.5em;">
    <div class="card" style="margin-bottom: 1em;">
      <nav class="navbar navbar-expand-lg mavbar-light bg-light">
        ...
        <form class="form-inline" method="post" action="../controller/remessa_controller.php?"> 
          <div class="input-group">
            <!--select name="empresa_id" class="custom-select" id="empresa_id" value="empresa_id" aria-label="Selecione uma empresa"  required style="font-size: 0.9em">
              <option selected="true" id="0" value=""></option>
              <?php 
              $acao6 = 'recuperar2';
            ...
            <!--select class="custom-select" id="tipoM" name="tipoM" aria-label="Exemplo de select com botão addon" style="font-size: 0.9em">
              <option selected></option>
              <option name="tipoM" value="1">Entrada</option>
              <option name="tipoM" value="2">Saída</option> 
            </select--> 
            <!--select class="custom-select" name="st" id="st" aria-label="Exemplo de select com botão addon" style="font-size: 0.9em">
              <option selected></option>
              <option name="st" value="2">Concluída</option>
              <option name="st" value="1">Pendente</option>
            </select-->        
            <div class="input-group-append">
              <!--input type="text" class="form-control" placeholder="" aria-label="" style="font-size: 0.9em"-->
              <!--button class="btn btn-outline-primary btn-sm" type="button" id="pesqPorcamposTabel" style="font-size: 0.9em"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
        ...
        <form class="form-inline" method="" action="../controller/remessa_controller.php?acao8=recuperarbynfe">  
          <div class="input-group">
            <input type="text" class="form-control" placeholder="Pesquisar por NFe" aria-label="" name="nfe" id="nfe" value="<?= $nfe?>" title="Digite aqui" style="font-size: 0.9em">   
            <div class="input-group-append">
              <!--input type="text" class="form-control" placeholder="" aria-label="" style="font-size: 0.9em"-->
    ...
    <div class="card card-columns" style="height: 44.5em; padding: 0px; border:;">
            <div class="card bg-light border-light md-2 font-weight-light">
              <div class="card-body">
                <h5 class="card-title text-left" style="margin-bottom:;">Remessas</h5>
                <div class="">
                  <div style="" id="ativos">
                    <!-- -->
                    <table class="table table-striped table-responsive-sm table-condensed table-sm text-center table-bordered table-hover" style="margin-top: 0em;font-size: 0.9em;">
                          <thead>
                            <tr>
                              ...
                              <th class="text-" scope="col" style="width: 6em;">Bloqueio</th>
                              ...
                              <th class="text-" scope="col" style="width: 3em;">Apagar</th>
                                ...
                                <div class="col-sm-9" id="<?= $remessa->id ?>">
                                  <form method="post" action="remessa.php?acao8=atualizar">
                                    ...
                                    <?php if( $remessa->bloqueio == 1) { ?>
                                      <td><input type="hidden" name="bloqueio" value="<?= $remessa->bloqueio?>"></input>Não</td>
                                    <?php } ?>
                                    <?php if ($remessa->bloqueio ==  2) { ?>
                                      <td><input type="hidden" name="bloqueio" value="<?= $remessa->bloqueio?>"></input>Sim</td>
                                    <?php } ?>
