<nav class="navbar sticky-top navbar-expand-sm navbar-light bg-primary">
			...
			<a href="index.php?pagina=1"><img class="img-responsive img-fluid img-thumbnai btn-sm" src="../imagens/logo-f-primary-007bff.png" style="width: 8em; height: 2.7em"></a>
	            ...
	            <ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown dropleft">
						...
						<dir class="dropdown-menu">
		                    ...
		                    <a href="todas.remessas.php?pagina=1" class="dropdown-item btn-sm" style="font-size: 0.7em;">Remessa</a>
		                    ...
		                    <a href="todos.retornos.php?pagina=1" class="dropdown-item btn-sm" style="font-size: 0.7em;">Devoluções</a>
		                    <!--div class="dropdown-divider"></div-->
		                    <a href="../relatorios/relatorios.php" class="dropdown-item btn-sm" style="font-size: 0.7em;">Relatório</a>
		                    <a href="uploadExcel.php?acaoImp=1" class="dropdown-item btn-sm " style="font-size: 0.7em;">Importar</a>
		                    <!--a href="todas.remessas.php?pagina=1" class="dropdown-item btn-sm">Excel</a-->
		                    <div class="dropdown-divider"></div>
						<!--/dir->
		                ...
		                <!--div class="dropdown-menu"-->
		                    ...
		                    <a href="todas.opfiscais.php?pagina=1" class="dropdown-item btn-sm" style="font-size: 0.7em;">Operação Fiscal</a>
		                    <a href="todos.cfops.php?pagina=1" class="dropdown-item btn-sm" style="font-size: 0.7em;">CFOP</a>
		                    <!--div class="dropdown-divider"></div>
		                    <a href="todos.status.php?pagina=1" class="dropdown-item btn-sm">Status</a-->
		                    <!--div class="dropdown-divider"></div-->
		                    <a href="todas.cidades.php?pagina=1" class="dropdown-item btn-sm" style="font-size: 0.7em;">Cidades</a>
		                    <a href="todos.estados.php?pagina=1" class="dropdown-item btn-sm" style="font-size: 0.7em;">Estados</a>
		                    <a href="todos.paises.php?pagina=1" class="dropdown-item" style="font-size: 0.7em;">Paises</a>
		                	<!--div class="dropdown-divider"></div>
